...
export function calculateDailyRate(company, workDaysThisMonth, referenceDate = null) {
...
export function calculateCompanyEarnings(company, now, workDaysThisMonth) {
  ...
  if (companyStartDate.getFullYear() >= year) {
    ...
    if (startMonth === month && startYear === year) {
      ...
      const dailyRateStartMonth = calculateDailyRate(company, startMonthWorkDays, companyStartDate);
